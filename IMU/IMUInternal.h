 ...
 * IMUInternal.h
 *
 * Created: 3/28/2015 11:10:42 PM
 *  Author: ekt
 */ 


#ifndef IMUINTERNAL_H_
#define IMUINTERNAL_H_
...
#define MAGN_X_MIN ((float) -578)
#define MAGN_X_MAX ((float) 776)
#define MAGN_Y_MIN ((float) -562)
#define MAGN_Y_MAX ((float) 1179)
#define MAGN_Z_MIN ((float) -1039)
#define MAGN_Z_MAX ((float) 314)
...
#define GYRO_AVERAGE_OFFSET_X ((float) 32.6)
#define GYRO_AVERAGE_OFFSET_Y ((float) 35.4)
#define GYRO_AVERAGE_OFFSET_Z ((float) 5.27)
